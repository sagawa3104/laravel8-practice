        ...
        <div class="contents__content__form">
            <div class="form-box">
                ...
                <div class="form-box__content">
                    <form class="form" method="POST" action="{{ route('processes.store') }}">
                        @csrf
                        <div class="form__group">
                            <label class="form-label" for="code">工程コード:</label>
                            <input class="form-input" type="text" id="code" name="process_code">
                            @error('process_code')
                        ...
                        <div class="form__group">
                            ...
                            <input class="form-input" type="text" id="name" name="process_name">
                            @error('process_name')
                                <p class="form-message form-message--error">{{ $message }}</p>
                            @enderror
                        </div>
