    ...
    <div class="contents__content">
                ...
                <div class="form-box__content">
                    <form class="form" method="POST" action="{{ route('recorded-products.update', [$recordedProduct->id]) }}">
                        ...
                        <div class="form__group">
                            ...
                            <input class="form-input form-input" type="text" id="recorded_number" name="recorded_number" value="{{$recordedProduct->recorded_number}}" disabled>
                        </div>
                        <div class="form__group">
                            ...
                            <select class="form-input form-input--select" type="text" id="product" name="product">
                                ...
                                <option value="{{$product->id}}" {{$recordedProduct->product_id == $product->id? 'selected':''}}>{{$product->code. ':'. $product->name}}</option>
                                @endforeach
                            </select>
                            @error('product')
        ...
        <div class="modal-wrapper" id="modal_id">
            ...
            <div class="modal-wrapper__window">
                ...
                <div class="form-box">
                    <div class="form-box__header">
                        <h1>{{$recordedProduct->product->code. ':' .$recordedProduct->product->name}}</h1>
                    </div>
                    <div class="form-box__content">
                        <p>本当に削除しますか？</p>
                    </div>
